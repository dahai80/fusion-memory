...
> **Current version: v1.1.0 (Commercial GA)** — Commercial release. Hard blockers all closed + real-test verification + three RC known limitations all resolved. Known limitations in `CHANGELOG.md` "Known limitations", non-blocking.
