...
fn main() {
    ...
    let result = serde_json::json!({
        "_doc": "P1-7 scale bench (local-store, StubEmbedder dim=64). audit §8 P1-7.",
        "_run": "FM_SCALE=<10k|100k|1m> cargo bench -p fm-engine --bench scale_bench",
